...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        elif os.path.exists(os.path.join(args.source_path,"scene_info.pth")):
            print("Found scene_info.pth file, assuming readyinfo data set!")
            scene_info = sceneLoadTypeCallbacks["readyinfo"](args.source_path)
